# =============================================================================
# 3D BEAM COMPLIANCE EVALUATION SCRIPT
# =============================================================================
#
# Description:
...
RESULTS_DIR = "results/3D_2x1x1_4Legs"
...
function analyze_simp_mesh(filepath::String, taskname::String)
    ...
    all_constraint_nodes = fixed_nodes
...
@testset "3D Beam Compliance Evaluation" begin
...
if abspath(PROGRAM_FILE) == @__FILE__
    println("\n" * "="^80)
    println("3D BEAM COMPLIANCE EVALUATION")
    println("="^80)
