...
export apply_volume_force!,
    apply_gravity!, apply_acceleration!, apply_variable_density_volume_force!
...
Returns:
  ...
  - Tuple containing:
      ...
      + Global load vector f  # 3D problem
"""
...
Returns:
  ...
  - Tuple with:
      ...
      + Cell ID where the maximum stress occurs    # Initialize storage for stresses
"""
